...
function openSignForm(aud){SG_AUD=aud;
  ...
  var deal=(aud=="buyer")
   ? '<div id="sg_buyerdeal" style="margin-top:12px"><div class="muted sglbl"><svg class=eico viewBox="0 0 18 18"><path d="M11.8 3.4l2.8 2.8L6 14.8 3 15.4l.6-3z"/><path d="M10.6 4.6l2.8 2.8"/></svg>סוג עסקה ועמלה</div>'
     +'<label style="display:flex;gap:8px;align-items:center;margin-top:8px;flex-wrap:wrap"><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input type=checkbox id="sg_buy" checked> קניה — עמלה</span><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input id="sg_cbuy" class=chip style="width:52px" inputmode=decimal value="2"> <select id="sg_cbuyunit" class=chip style="width:52px"><option>%</option><option>₪</option></select></span></label>'
     +'<label style="display:flex;gap:8px;align-items:center;margin-top:8px;flex-wrap:wrap"><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input type=checkbox id="sg_rent"> שכירות — עמלה</span><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input id="sg_crent" class=chip style="width:52px" inputmode=decimal value="1"> חודשים</span></label></div>'
   : '<div id="sg_sellerdeal" style="margin-top:12px"><div class="muted sglbl"><svg class=eico viewBox="0 0 18 18"><path d="M11.8 3.4l2.8 2.8L6 14.8 3 15.4l.6-3z"/><path d="M10.6 4.6l2.8 2.8"/></svg>סוג עסקה ועמלה</div>'
     +'<label style="display:flex;gap:8px;align-items:center;margin-top:8px;flex-wrap:wrap"><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input type=checkbox id="sg_sell" checked> מכירה — עמלה</span><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input id="sg_scbuy" class=chip style="width:52px" inputmode=decimal value="2"> <select id="sg_scbuyunit" class=chip style="width:52px"><option>%</option><option>₪</option></select></span></label>'
     +'<label style="display:flex;gap:8px;align-items:center;margin-top:8px;flex-wrap:wrap"><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input type=checkbox id="sg_srent"> השכרה — עמלה</span><span style="display:inline-flex;align-items:center;gap:6px;white-space:nowrap"><input id="sg_scrent" class=chip style="width:52px" inputmode=decimal value="1"> חודשים</span></label>'
  ...
  $("view").innerHTML='<div class=card><div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><h2 style="margin:0">'+title+'</h2><button class="sgback" onclick="tab(\'sigs\')"><svg viewBox="0 0 18 18"><path d="M7 4l5 5-5 5"/></svg>חזרה</button></div>'
   ...
   +'<label style="display:block;margin-top:6px;line-height:1.5"><input type=radio name="sgmode" value="remote" checked onchange="sgMode()" style="vertical-align:middle;margin-left:6px"> שליחה לחתימה ב-SMS ו-WhatsApp</label>'
   +'<label style="display:block;margin-top:6px;line-height:1.5"><input type=radio name="sgmode" value="local" onchange="sgMode()" style="vertical-align:middle;margin-left:6px"> הפקה ללא שליחה (חתימה במקום)</label></div>'
